...
function stringifyPair({ key, value }, ctx, onComment, onChompKeep) {
    const { allNullValues, doc, indent, options: { commentString, indentSeq, keepIndent, simpleKeys } } = ctx;
    ...
    if (keepIndent &&
        ...
        if (diff > 0 || (identity.isSeq(value) && !value.flow)) {
